...
async fn main() -> anyhow::Result<()> {
  ...
  // Initialize the logger with a custom format that includes timestamps with milliseconds
  Builder::new()
      .format(|buf, record| {
  ...
  let args = Args::parse(); // Assuming Args is defined elsewhere in your code
